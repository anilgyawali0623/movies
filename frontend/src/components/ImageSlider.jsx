...
function App() {
  const slides = [
    ...
    {
      url: 'https://images.unsplash.com/photo-1511875762315-c773eb98eec0?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    },
    {
  ...
  return (
    <div className='max-w-full h-[620px] w-full mt-5  relative group'>
      <div
